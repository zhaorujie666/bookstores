    ...
    <i-dialog
      ...
      <el-form :model="dialogFormData" ref="form" :rules="formRules" label-width="120px">
        <el-row>
          <el-col :span='12'>
            <el-form-item label="门店名称" prop="storeName">
              <el-input v-model="dialogFormData.storeName" :disabled="this.dialogType === 'detail'" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='12'>
          ...
          <el-col :span='12'>
            <el-form-item label="店长编号" prop="userId">
              <el-input v-model="dialogFormData.userId" :disabled="this.dialogType === 'detail'" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='12'>
            <el-form-item label="营业执照编码" prop="businessCode">
              <el-input v-model="dialogFormData.businessCode" :disabled="this.dialogType === 'detail'" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='12'>
            <el-form-item label="所在省份" prop="provinceId">
          ...
          <el-col :span="12">
            <el-form-item label="详细地址" prop="address">
              <el-input type="textarea" v-model="dialogFormData.address" :disabled="this.dialogType === 'detail'" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  data () {
    return {
      ...
      toolbar: [
        {
          ...
          func: () => {
            ...
            req('getShop', {storeId: this.tableSelectRows[0].storeId}).then(data => {
              Promise.all([
        ...
        },
        {
          ...
          func: () => {
            ...
            this.$confirm('此操作将永久删除该文件,是否继续?').then(() => {
              ...
              req('deleteShop', {storeId: ids, nowRole: JSON.parse(sessionStorage.getItem('roleInfo')).role}).then(data => {
      ...
      columnList: [
        ...
        {label: '门店邀请码', prop: 'inviteCode'},
        {label: '门店账号', prop: 'userAcct', width: 200}
      ],
      tableData: [],
      tableSelectRows: [],
      formRules: {
        ...
        userId: [
          { required: true, message: '请选择店长编号', trigger: 'change' }
        ],
        businessCode: [
        ...
        if (this.dialogVisible) {
          ...
          req('getAreaData', {areaId: id}).then(data => {
            this.dialogCityOptions = data.data.areaList.map(item => {
              return Object.assign({}, data.data.areaList, {label: item.areaName, value: item.areaId})
            })
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          if (this.dialogType === 'add') {
            req('addShop', {...this.dialogFormData, nowRole: JSON.parse(sessionStorage.getItem('roleInfo')).role}).then(data => {
              if (data.code === 0) {
                this.$message.success(data.msg)
            ...
            req('updateShop', {...this.dialogFormData}).then(data => {
              if (data.code === 0) {
                this.$message.success(data.msg)
